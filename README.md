...
<style>
  ...
  .terminal {
    ...
    font-size: 0.85rem; /* made slightly bigger for phones */
    line-height: 1.4;
...
<body>
  ...
  <p>🎮 First, climb the staircase by filling in the blanks! 🎮</p>
  ...
  <div class="terminal-container">
    <p>🎮 Next, enter the <b>Mathrix Terminal</b> to solve equations & functions 🎮</p>
...
const correctAnswers = {
  ...
  14:{question:"(x - 50)/(x - 30) = 5/4",answers:["70"]}, <!-- fixed -->
  ...
  /* ... rest of your dataset unchanged ... */
};
